...
| `onboarding-scope` | Onboarding resources to manage. Use full for workspace, spec, and collection assets, or spec-only for workspace/spec onboarding while leaving existing generated assets unchanged. | no | `full` |
